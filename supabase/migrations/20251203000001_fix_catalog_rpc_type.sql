-- Fix get_shadowing_catalog return type mismatch
-- Revert dialogue_type to text to match actual query output
...
RETURNS TABLE(
  ...
  topic text,
  genre text,
  dialogue_type text, -- CHANGED FROM public.dialogue_type_enum TO text
  register text,
  notes jsonb,
  translations jsonb,
