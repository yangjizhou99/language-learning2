...
revoke delete on table "public"."subtopic_scene_vectors" from "anon";

revoke insert on table "public"."subtopic_scene_vectors" from "anon";

revoke references on table "public"."subtopic_scene_vectors" from "anon";

revoke select on table "public"."subtopic_scene_vectors" from "anon";

revoke trigger on table "public"."subtopic_scene_vectors" from "anon";

revoke truncate on table "public"."subtopic_scene_vectors" from "anon";

revoke update on table "public"."subtopic_scene_vectors" from "anon";

revoke delete on table "public"."subtopic_scene_vectors" from "authenticated";

revoke insert on table "public"."subtopic_scene_vectors" from "authenticated";

revoke references on table "public"."subtopic_scene_vectors" from "authenticated";

revoke select on table "public"."subtopic_scene_vectors" from "authenticated";

revoke trigger on table "public"."subtopic_scene_vectors" from "authenticated";

revoke truncate on table "public"."subtopic_scene_vectors" from "authenticated";

revoke update on table "public"."subtopic_scene_vectors" from "authenticated";

revoke delete on table "public"."subtopic_scene_vectors" from "service_role";

revoke insert on table "public"."subtopic_scene_vectors" from "service_role";

revoke references on table "public"."subtopic_scene_vectors" from "service_role";

revoke select on table "public"."subtopic_scene_vectors" from "service_role";

revoke trigger on table "public"."subtopic_scene_vectors" from "service_role";

revoke truncate on table "public"."subtopic_scene_vectors" from "service_role";

revoke update on table "public"."subtopic_scene_vectors" from "service_role";
...
drop table "public"."subtopic_scene_vectors";
...
alter table "public"."shadowing_drafts" alter column "dialogue_type" set data type public.dialogue_type_enum using "dialogue_type"::public.dialogue_type_enum;
