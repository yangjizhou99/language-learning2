...
function generateApiReport(results) {
  ...
  console.log(`最快 API: ${report.summary.fastestApi.name} (${report.summary.fastestApi.avgTime.toFixed(2)}ms)`);
  console.log(`最慢 API: ${report.summary.slowestApi.name} (${report.summary.slowestApi.avgTime.toFixed(2)}ms)`);
