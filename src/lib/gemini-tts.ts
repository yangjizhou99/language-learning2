...
// 根据语言和角色推荐音色
export function recommendVoiceForSpeaker(
  speaker: string,
  lang: string,
  ...
  const langVoices = {
    en: {
      ...
      C: {
        ...
        stylePrompt: '以女性、明亮、友好的风格朗读，注意自然停连、口语化',
      },
    ...
    ja: {
      A: {
        ...
        stylePrompt: '以女性、清晰、自然的风格朗读，注意自然停连、口语化',
      },
      B: {
        voiceName: 'ja-JP-Neural2-D',
        stylePrompt: '以男性、中性、随意的风格朗读，注意自然停连、口语化',
      },
      C: {
      ...
      D: {
        ...
        stylePrompt: '以男性、年轻、活泼的风格朗读，注意自然停连、口语化',
      },
    },
    zh: {
      A: {
        voiceName: 'cmn-CN-Chirp3-HD-Kore',
        stylePrompt: '以女性、清晰、自然的风格朗读，注意自然停连、口语化',
      },
      B: {
        voiceName: 'cmn-CN-Chirp3-HD-Orus',
        stylePrompt: '以男性、中性、随意的风格朗读，注意自然停连、口语化',
      },
      C: {
        voiceName: 'cmn-CN-Chirp3-HD-Callirrhoe',
        stylePrompt: '以女性、明亮、友好的风格朗读，注意自然停连、口语化',
      },
      D: {
        voiceName: 'cmn-CN-Chirp3-HD-Puck',
        stylePrompt: '以男性、年轻、活泼的风格朗读，注意自然停连、口语化',
      },
    },
  };
...
export async function synthesizeGeminiDialogue({
  ...
  for (const { speaker, content } of dialogue) {
    ...
    const voiceConfig = speakers.includes(speaker)
      ? {
          voiceName: speakers[speakers.indexOf(speaker) + 1] || 'Kore',
          stylePrompt: stylePrompts[speaker] || '以自然、清晰的风格朗读',
        }
