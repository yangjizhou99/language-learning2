    ...
    <div className="japanese-shadowing-interface">
      ...
      <style jsx>{`
        .japanese-shadowing-interface {
          font-family: "Hiragino Sans", "Yu Gothic", "Meiryo", "MS PGothic", "Takao", "IPAexGothic", "IPAPGothic", "VL PGothic", "Noto Sans CJK JP", "Hiragino Kaku Gothic ProN", "Hiragino Kaku Gothic Pro", "Yu Gothic Medium", "Yu Gothic", "Meiryo", sans-serif;
          font-weight: 400;
