                      ...
                      {currentRecordings.length > 0 ? (
                        <div className="text-center space-y-4">
                          <div className="p-4 bg-white/80 rounded-xl border border-purple-200">
                            ...
                            <p className="text-gray-700 font-medium mb-2">{t.shadowing.recording_completed || "Recording completed!"}</p>
                        ...
                        <div className="text-center py-8">
                          ...
                          <h3 className="text-lg font-semibold text-gray-700 mb-2">{t.shadowing.no_recording_yet || "No recording yet"}</h3>
                  ...
                  {scoringResult && (
                    <Card className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-0 shadow-xl rounded-2xl">
                      <div className="flex items-center justify-between mb-6">
                        ...
                        >
                          {isScoring ? (t.shadowing.re_scoring_in_progress || "重新Scoring...") : (t.shadowing.re_score || "Re-score")}
                        </Button>
                      </div>
                      ...
                      {scoringResult.transcription && scoringResult.originalText && (
                        <div className="mt-4">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="mt-4 p-3 bg-blue-50 rounded border border-blue-200">
                              <div className="text-sm text-blue-600 mb-2">{t.shadowing.detailed_analysis || "Detailed Analysis"}</div>
                              <div className="text-sm text-gray-700">
                                {(() => {
                                  ...
                                  return (
                                    <div>
                                          ...
                                          <div key={`sentence-${idx}-${sentence.sentence.substring(0, 20)}`} className={`p-3 rounded border ${
                                            ...
                                            {sentence.issues.length > 0 && (
                                              <div className="text-sm text-red-600">
                                                <div className="font-medium">{t.shadowing.issues || "Issues"}:</div>
                                      ...
                                      <div className="mt-4 text-xs text-gray-500">
                                        💡 {t.shadowing.analysis_based_on_sentence_level || "分析基于Sentence级别，更直观地显示发音Issues"}
                                      </div>
                                    </div>
                                  );
                                            ...
                                            <div key={idx} className={`p-3 rounded border ${
                                              ...
                                              {sentence.issues.length > 0 && (
                                                <div className="text-xs">
                                                  <span className="font-medium text-red-600">{t.shadowing.issues || "Issues"}:</span>
