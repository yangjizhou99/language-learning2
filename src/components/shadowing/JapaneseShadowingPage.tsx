    ...
    return (
      <div className="text-sm text-gray-700">
        <div className="mb-2 flex items-center gap-2">
          <strong>{t.shadowing.explanation || '翻訳'}：</strong>
        ...
        {latestExplanation.pos && (
          <div className="mb-2 text-sm text-gray-600">
            <strong>{t.shadowing.part_of_speech || '品詞'}：</strong>
            {latestExplanation.pos}
          </div>
        )}
                    ...
                    <Card className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 border-0 shadow-xl rounded-2xl">
                      ...
                      {currentRecordings.length > 0 ? (
                        <div className="text-center space-y-4">
                          <div className="p-4 bg-white/80 rounded-xl border border-purple-200">
                            ...
                            <p className="text-gray-700 font-medium mb-2">
                              {t.shadowing.recording_completed || '録音完了！'}
                            </p>
                        ...
                        <div className="text-center py-8">
                          ...
                          <h3 className="text-lg font-semibold text-gray-700 mb-2">
                            {t.shadowing.no_recording_yet || 'まだ録音していません'}
                          </h3>
                  ...
                  {scoringResult && (
                    <Card className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-0 shadow-xl rounded-2xl">
                      <div className="flex items-center justify-between mb-6">
                        ...
                        >
                          {isScoring
                            ? t.shadowing.re_scoring_in_progress || '重新採点中...'
                            : t.shadowing.re_score || '再採点'}
                        </Button>
                      </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="mt-4 p-3 bg-blue-50 rounded border border-blue-200">
                              <div className="text-sm text-blue-600 mb-2">
                                {t.shadowing.detailed_analysis || '詳細分析'}
                              </div>
                              <div className="text-sm text-gray-700">
                                {(() => {
