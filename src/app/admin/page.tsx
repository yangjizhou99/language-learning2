    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg border shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/admin/articles" className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
            <h3 className="font-medium text-gray-900">📝 题库管理</h3>
            <p className="text-sm text-gray-600 mt-1">AI生成、手动录入、内容抓取</p>
          </Link>
          <Link href="/admin/drafts" className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
            <h3 className="font-medium text-gray-900">📋 草稿箱</h3>
            <p className="text-sm text-gray-600 mt-1">审核、编辑、发布草稿</p>
          </Link>
          <Link href="/admin/drafts/batch" className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
