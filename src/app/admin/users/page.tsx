      ...
      try {
        ...
        alignmentStats?.forEach((attempt) => {
          ...
          if (stats[userId]) {
            ...
            if (
              attempt.scores &&
              typeof attempt.scores === 'object' &&
              'overall' in attempt.scores
            ) {
                        ...
                        <TableCell>
                          <div className="space-y-1">
                            ...
                            <div className="text-xs text-muted-foreground">
                              Shadowing: {user.practice_stats.total_shadowing_attempts} | Cloze:{' '}
                              {user.practice_stats.total_cloze_attempts} | Alignment:{' '}
                              {user.practice_stats.total_alignment_attempts}
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
