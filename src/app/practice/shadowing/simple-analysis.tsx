// 简单直观的句子对比分析组件
export const SimpleAnalysisDisplay = ({ originalText, transcribedText }: { originalText: string, transcribedText: string }) => {
  // 将原文按句子分割（以A:, B:为分界）
  ...
  for (const sentence of originalSentences) {
    ...
    // 计算句子匹配度
    const matchedWords = cleanSentence.filter(word => 
      cleanTranscribed.includes(word)
    );
