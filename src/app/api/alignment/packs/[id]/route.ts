  ...
  const mockPack = {
    ...
    steps: {
      ...
      D1: {
        ...
        exemplar: "A: 你好，我想订餐。\nB: 您好，请问需要点什么？\nA: 我要一份宫保鸡丁和一碗米饭。\nB: 好的，还需要别的吗？\nA: 不用了，谢谢。\nB: 请稍等，马上就好。",
        key_phrases: ["你好", "我想订餐", "请问需要点什么", "我要一份", "还需要别的吗", "不用了，谢谢", "请稍等"],
        patterns: ["我想+动词", "我要+数量+名词", "还需要+什么", "请稍等"],
        rubric: { fluency: "基本对话流畅", relevance: "符合订餐场景", style: "礼貌用语", length: "4-6轮对话" },
      ...
      D2: {
        ...
        exemplar: "A: 您好，我想订一份外卖。\nB: 好的，您想点些什么？\nA: 请给我来一份鱼香肉丝，不要放辣椒。另外再加一份炒青菜。\nB: 鱼香肉丝不加辣椒，炒青菜一份。需要主食吗？\nA: 要两碗米饭。大概多久能送到？\nB: 大约30分钟。您的地址是？\nA: 人民路123号。\nB: 好的，总计45元。\nA: 谢谢，我等你。",
        key_phrases: ["我想订外卖", "不要放辣椒", "另外再加", "需要主食吗", "大概多久能送到", "您的地址是", "总计多少钱"],
        patterns: ["不要+动词", "另外+动词", "大概+时间+能+动词", "总计+金额"],
        rubric: { fluency: "对话自然流畅", relevance: "包含特殊要求", style: "礼貌且详细", length: "6-8轮对话" },
      ...
      T3: {
        ...
        exemplar: "我喜欢用手机App订餐，因为很方便。我可以看到很多餐厅的菜单和评价，还能用优惠券。有时候我也会打电话订餐，特别是当我想吃的那家餐厅没有App的时候。我觉得订餐最重要的是食物要好吃，送餐要快。",
        key_phrases: ["我喜欢", "因为", "可以看到", "还能", "有时候", "特别是", "我觉得", "最重要的是"],
        patterns: ["我喜欢+名词+因为+原因", "有时候+情况+特别是+条件", "我觉得+观点"],
        rubric: { fluency: "表达流畅自然", relevance: "涉及订餐偏好", style: "个人化表达", length: "60-80字" },
      ...
      W4: {
        ...
        exemplar: "昨天我用App订了一份披萨和沙拉。披萨很好吃，但沙拉有点咸。送餐很快，只用了25分钟。下次我还会订这家的披萨，但不会点沙拉了。",
        checklist: ["包含时间", "描述食物", "评价味道", "提及送餐速度", "表达感受", "提出建议"],
        rubric: { fluency: "句子通顺", relevance: "包含订餐要素", style: "个人化描述", length: "50-70字" }
      },
      T5: {
        type: "task_email",
        title: "订餐咨询邮件",
        ...
        rubric: { fluency: "邮件格式正确", relevance: "包含关键信息", style: "正式礼貌", length: "80-120字" }
      },
      W6: {
        type: "writing_long",
        title: "订餐体验长文",
        prompt: "写一篇长文，详细描述一次订餐体验，包括选择过程、订单细节、送餐和评价。",
        exemplar: "上周五晚上，我和朋友决定订餐。我们在几个App上看了很多餐厅，最后选了一家评分高的中餐馆。我点了一份麻婆豆腐和米饭，朋友点了糖醋里脊。订单确认后，预计30分钟送达。实际上只用了25分钟，送餐员很友好。麻婆豆腐非常好吃，辣味适中，但糖醋里脊有点太甜了。总体体验很好，下次还会光顾。",
        outline: ["介绍订餐时间和方式", "描述选择过程", "分享订单细节", "评价送餐服务", "总结整体体验"],
        rubric: { fluency: "段落连贯", relevance: "覆盖完整流程", style: "叙事性描述", length: "120-150字" }
      }
    }
  };
