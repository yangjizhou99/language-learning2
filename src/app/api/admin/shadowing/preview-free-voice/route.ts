...
const BROWSER_VOICE_MAP: { [key: string]: { voice: string; lang: string; gender: string } } = {
  ...
  'Browser-CN-Male-2': {
    voice: 'Microsoft Yunyang - Chinese (Simplified, PRC)',
    lang: 'zh-CN',
    gender: 'male',
  },
  'Browser-CN-Female-3': {
    voice: 'Microsoft Xiaoxiao - Chinese (Simplified, PRC)',
    lang: 'zh-CN',
    gender: 'female',
  },
  'Browser-CN-Male-3': {
    voice: 'Microsoft Yunxi - Chinese (Simplified, PRC)',
    lang: 'zh-CN',
    gender: 'male',
  },
  'Browser-EN-Female-1': {
    voice: 'Microsoft Aria - English (United States)',
    lang: 'en-US',
    gender: 'female',
  },
  'Browser-EN-Male-1': {
    voice: 'Microsoft Davis - English (United States)',
    lang: 'en-US',
    gender: 'male',
  },
  'Browser-EN-Female-2': {
    voice: 'Microsoft Jenny - English (United States)',
    lang: 'en-US',
    gender: 'female',
  },
  'Browser-EN-Male-2': {
    voice: 'Microsoft Guy - English (United States)',
    lang: 'en-US',
    gender: 'male',
  },
  'Browser-JA-Female-1': {
    voice: 'Microsoft Nanami - Japanese (Japan)',
    lang: 'ja-JP',
    gender: 'female',
  },
  'Browser-JA-Male-1': {
    voice: 'Microsoft Keita - Japanese (Japan)',
    lang: 'ja-JP',
    gender: 'male',
  },
};
