      ...
      try {
        ...
        const { error: insertError } = await supabase
          ...
          .insert({
            ...
            category: voice.displayName.includes('新闻播报') ? 'Xunfei-News-Female' : 
                     voice.displayName.includes('新闻播报') ? 'Xunfei-News-Male' :
                     voice.gender === 'female' ? 'Xunfei-Female' : 'Xunfei-Male',
            is_active: true,
            provider: 'xunfei',
