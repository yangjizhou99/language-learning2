  ...
  try {
    ...
    const geminiVoices = [
      // 英语 Gemini TTS 音色（真正的AI增强音色）
      {
        ...
        pricing: { pricePerMillionChars: 20, examplePrice: '0.0200', examplePrice10k: '2.00' },
        characteristics: { voiceType: '女性', tone: '女声', pitch: '中高音' },
        display_name: 'Kore (Gemini)',
        category: 'Gemini-Female',
        provider: 'gemini',
        useCase: 'AI增强、创新应用',
        is_active: true,
      },
      {
        ...
        natural_sample_rate_hertz: 24000,
        pricing: { pricePerMillionChars: 20, examplePrice: '0.0200', examplePrice10k: '2.00' },
        characteristics: { voiceType: '男性', tone: '男声', pitch: '中低音' },
        display_name: 'Orus (Gemini)',
        category: 'Gemini-Male',
        provider: 'gemini',
        useCase: 'AI增强、创新应用',
        is_active: true,
      },
      {
        ...
        pricing: { pricePerMillionChars: 20, examplePrice: '0.0200', examplePrice10k: '2.00' },
        characteristics: { voiceType: '女性', tone: '女声', pitch: '中高音' },
        display_name: 'Callirrhoe (Gemini)',
        category: 'Gemini-Female',
        provider: 'gemini',
        useCase: 'AI增强、创新应用',
        is_active: true,
    ...
    if (countError) {
      ...
      const providerCounts =
        allVoices?.reduce((acc: any, voice: any) => {
