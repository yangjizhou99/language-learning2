...
import { validateInvitationCode, useInvitationCode, applyInvitationPermissions, applyInvitationApiLimits } from '@/lib/invitation';
    ...
    try {
      ...
      if (validationResult.permissions) {
        ...
        if (validationResult.permissions.api_limits) {
          const apiLimitsResult = await applyInvitationApiLimits(userId, validationResult.permissions.api_limits);
