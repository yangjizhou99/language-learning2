...
const MODEL_CONFIGS = {
  openrouter: {
    ...
    models: [
      ...
      // Anthropic Claude 系列
      { id: 'anthropic/claude-3.5-sonnet', name: 'Claude 3.5 Sonnet', description: 'Anthropic最新模型，性能卓越' },
      ...
      { id: 'anthropic/claude-instant-1.2', name: 'Claude Instant 1.2', description: 'Claude快速版本' },
      ...
      { id: 'openai/gpt-4-turbo-preview', name: 'GPT-4 Turbo Preview', description: 'GPT-4 Turbo预览版本' },
      ...
      { id: 'openai/gpt-3.5-turbo-16k', name: 'GPT-3.5 Turbo 16K', description: 'GPT-3.5长上下文版本' },
      { id: 'openai/o1-preview', name: 'o1 Preview', description: 'OpenAI推理模型' },
      { id: 'openai/o1-mini', name: 'o1 Mini', description: 'OpenAI快速推理模型' },
      { id: 'openai/gpt-5-preview', name: 'GPT-5 Preview (待发布)', description: 'OpenAI下一代模型预览' },
      ...
      { id: 'meta-llama/llama-3.1-70b-instruct', name: 'Llama 3.1 70B', description: 'Meta大参数模型' },
      { id: 'meta-llama/llama-3.1-405b-instruct', name: 'Llama 3.1 405B', description: 'Meta超大参数模型' },
      { id: 'meta-llama/llama-3.2-11b-vision-instruct', name: 'Llama 3.2 11B Vision', description: '支持视觉的Llama模型' },
      { id: 'meta-llama/llama-3.2-90b-vision-instruct', name: 'Llama 3.2 90B Vision', description: '大参数视觉模型' },
      { id: 'meta-llama/llama-3-8b-instruct', name: 'Llama 3 8B', description: 'Llama 3基础版本' },
      { id: 'meta-llama/llama-3-70b-instruct', name: 'Llama 3 70B', description: 'Llama 3大参数版本' },
      { id: 'meta-llama/llama-2-7b-chat', name: 'Llama 2 7B Chat', description: 'Llama 2对话模型' },
      { id: 'meta-llama/llama-2-13b-chat', name: 'Llama 2 13B Chat', description: 'Llama 2中等参数模型' },
      { id: 'meta-llama/llama-2-70b-chat', name: 'Llama 2 70B Chat', description: 'Llama 2大参数模型' },
      ...
      { id: 'deepseek/deepseek-reasoner', name: 'DeepSeek Reasoner', description: 'DeepSeek推理模型' },
      ...
      // Mistral 系列
      { id: 'mistralai/mistral-7b-instruct', name: 'Mistral 7B', description: 'Mistral 7B指令模型' },
      { id: 'mistralai/mixtral-8x7b-instruct', name: 'Mixtral 8x7B', description: 'Mistral混合专家模型' },
      { id: 'mistralai/mixtral-8x22b-instruct', name: 'Mixtral 8x22B', description: 'Mistral大参数混合模型' },
      ...
      { id: 'microsoft/phi-3-medium-4k-instruct', name: 'Phi-3 Medium', description: '微软Phi-3中等模型' },
      { id: 'microsoft/phi-3-mini-4k-instruct', name: 'Phi-3 Mini', description: '微软Phi-3小模型' },
      { id: 'stabilityai/stablelm-2-zephyr-1.6b', name: 'StableLM 2 Zephyr', description: 'Stability AI轻量模型' },
      { id: 'huggingface/zephyr-7b-beta', name: 'Zephyr 7B Beta', description: 'Hugging Face Zephyr模型' },
      { id: 'togethercomputer/llama-2-7b-chat', name: 'Llama 2 7B (Together)', description: 'Together AI托管版本' },
      { id: 'togethercomputer/llama-2-70b-chat', name: 'Llama 2 70B (Together)', description: 'Together AI大参数版本' }
    ]
  },
  deepseek: {
    name: 'DeepSeek',
