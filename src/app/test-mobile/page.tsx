        ...
        <div className="bg-gray-100 p-4 rounded-lg mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p>
                <strong>屏幕高度:</strong> {screenHeight}px
              </p>
              <p>
                <strong>设备类型:</strong> {isMobile ? '手机' : isTablet ? '平板' : '桌面'}
              </p>
            </div>
            <div>
              <p>
                <strong>强制移动模式:</strong> {forceMobileMode ? '是' : '否'}
              </p>
              <p>
                <strong>实际移动端:</strong> {actualIsMobile ? '是' : '否'}
              </p>
            </div>
          </div>
        </div>
